...
<div class="sidebar bg-dark">
  <a href="#" class="load-content" data-page="Dashboard.html">
    <i class="fas fa-tachometer-alt"></i> Dashboard
  </a>
  <a href="#" class="load-content" data-page="locateurs.php">
    <i class="fas fa-users"></i> Locateurs
  </a>
  <a href="#" class="load-content" data-page="Newlocateur.php">
    <i class="fas fa-user-plus"></i>&nbsp;Nouveau locateurs
  </a>
  <a href="#" onclick="loadMessages()">
      ...
      <div class="col-md-4">
        <div class="card text-white bg-info mb-3">
          <div class="card-body">
            ...
            <p class="card-text"><?=$db->CoutLocateurs();?></p>
          </div>
        </div>
      </div>
      <div class="col-md-4">
